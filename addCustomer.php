...
<div class="add-customer">
    ...
    <form action="" method="POST">
        <div class="field1">
            ...
            <div class="input1">
                <input type="text" placeholder="Enter Customer Name" name='name' size="20">
            </div>
        </div>
        <div class="field1">
            <div class="label1">
            ...
            <div class="input2">
                <input type="text" placeholder="Enter Email" name="email" size="20">
            </div>
        </div>
        <div class="field1">
            <div class="label1">
            ...
            <div class="input3">
                <input type="number" placeholder="Enter Phone Number" name="phn" size="20">
            </div>
        </div>
